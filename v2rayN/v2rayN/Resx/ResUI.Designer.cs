...
namespace v2rayN.Resx {
    ...
    internal class ResUI {
        ...
        /// <summary>
        ///   查找类似 Import {0} successfully, {1} failed 的本地化字符串。
        /// </summary>
        internal static string ImportedResultCountNotice {
            get {
                return ResourceManager.GetString("ImportedResultCountNotice", resourceCulture);
            }
        }
